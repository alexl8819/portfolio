...
resource "aws_apigatewayv2_api" "http_api" {
  ...
  cors_configuration {
    allow_origins = ["https://portfolio.${var.cors_domain}"]
...
resource "aws_acm_certificate" "cert" {
  domain_name       = "api.${var.cors_domain}"
...
output "api_endpoint" {
  value = "https://${aws_apigatewayv2_domain_name.custom.domain_name}/send"
}
